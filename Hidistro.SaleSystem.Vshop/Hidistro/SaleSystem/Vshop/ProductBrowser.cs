namespace Hidistro.SaleSystem.Vshop
{
    ...
    {
        public static bool AddProductToFavorite(int productId, int userId,string wid)
        {
            FavoriteDao dao = new FavoriteDao();
            return (dao.ExistsProduct(productId, userId) || dao.AddProductToFavorite(productId, userId,wid));
        }
        ...
        public static int GetProductConsultationsCount(int productId, bool includeUnReplied,int UserId)
        {
            return new ProductConsultationDao().GetProductConsultationsCount(productId, includeUnReplied, UserId);
        }
        ...
        public static int GetProductReviewsCount(int productId, int UserId)
        {
            return new ProductReviewDao().GetProductReviewsCount(productId, UserId);
        }
        ...
        public static DataTable GetProducts(string wid,MemberInfo member, int? topicId, int? categoryId, string keyWord, int pageNumber, int maxNum, out int total, string sort, string order, string pIds = "")
        {
            return new ProductBrowseDao().GetProducts(wid,member, topicId, categoryId, Globals.GetCurrentDistributorId(), keyWord, pageNumber, maxNum, out total, sort, order == "asc", pIds);
        }
        ...
        public static int GetProductsNumber()
        {
            ...
            {
                productsNumber = new ProductBrowseDao().GetProductsNumber(currentDistributorId);
            }
