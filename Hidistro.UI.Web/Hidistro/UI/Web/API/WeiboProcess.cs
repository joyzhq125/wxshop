namespace Hidistro.UI.Web.API
{
    ...
    public class WeiboProcess : IHttpHandler, IRequiresSessionState
    {
        ...
        public void editmessage(HttpContext context)
        {
            ...
            {
                s = "{\"status\":\"1\",";
                object obj2 = s + "\"Content\":\"" + replyInfoMes.Content + "\",";
                object obj3 = ((((string.Concat(new object[] { obj2, "\"Type\":\"", replyInfoMes.Type, "\"," }) + "\"ReceiverType\":\"" + replyInfoMes.ReceiverType + "\",") + "\"Displayname\":\"" + replyInfoMes.Displayname + "\",") + "\"Summary\":\"" + replyInfoMes.Summary + "\",") + "\"Image\":\"" + replyInfoMes.Image + "\",") + "\"Url\":\"" + replyInfoMes.Url + "\",";
        ...
        public void GetMenu(HttpContext context)
        {
            ...
            else
            {
                ...
                if (menu != null)
                {
                    ...
                    s = (((string.Concat(new object[] { obj2, "{\"menuid\": \"", menu.MenuId, "\"," }) + "\"type\": \"" + menu.Type + "\",") + "\"name\": \"" + menu.Name + "\",") + "\"content\": \"" + menu.Content + "\"}") + "]";
                }
                s = s + "}";
                context.Response.Write(s);
            }
