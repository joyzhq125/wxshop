            ...
            foreach (DataRow row in activityTopics.Rows)
            {
                ...
                if (!string.IsNullOrEmpty(str2))
                {
                    ...
                    else
                    {
                        ...
                        {
                            MemberGradeInfo memberGrade = MemberHelper.GetMemberGrade(int.Parse(str4));
                            str3 = str3 + memberGrade.Name + "、";
                        }
                        row["NewMemberGrades"] = str3.TrimEnd(new char[] { '、' });
                    }
                }
                if (num3 == 1)
                {
                    ...
                    switch (num3)
                    {
                        ...
                        case 5:
                        {
                            ...
                            if (modelByGameId != null)
                            {
                                ...
                                row["Limit"] = modelByGameId.PlayType;
