namespace Hidistro.UI.Web.API
{
    ...
    public class WeiBoAPI : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            string s = new Hidistro.ControlPanel.WeiBo.WeiBo().commentscreate(context.Request["id"], context.Request["comment"]);
            context.Response.Write(s);
        }

        public void createmenu(HttpContext context)
        {
            Hidistro.ControlPanel.WeiBo.WeiBo bo = new Hidistro.ControlPanel.WeiBo.WeiBo();
            string s = "";
        ...
        {
            string s = new WeiBo().user_timeline(int.Parse(context.Request["page"]));
            context.Response.Write(s);
        }
