                ...
                case MessageType.Text:
                    if (this.fkContent.Text.Length <= 0x3e8)
                    {
                        ...
                        if (reply.Keys == "*")
                        {
                            ...
                            if (ReplyHelper.GetNoMatchReplyID(this.replyID,this.wid) > 0)
                            {
                        ...
                        {
                            if (ReplyHelper.GetSubscribeID(this.replyID,this.wid) > 0)
                            {
                        ...
                        else
                        {
                            ...
                            if (ReplyHelper.HasReplyKey(reply.Keys, this.replyID,this.wid))
                            {
                ...
                case MessageType.List:
                    ...
                    if (!(info.Keys == "*"))
                    {
                        ...
                        else
                        {
                            ...
                            if (ReplyHelper.HasReplyKey(info.Keys, this.replyID,this.wid))
                            {
                                this.ShowMsg("该关键词已存在！", false);
                                return;
                            }
