namespace Hidistro.UI.Web.Admin.WeiXin
{
    ...
    public class ReplyOnKey : AdminPage
    {
        ...
        {
            List<Hidistro.Entities.VShop.ReplyInfo> list = ReplyHelper.GetAllReply(this.wid).ToList<Hidistro.Entities.VShop.ReplyInfo>().FindAll(a => a.ReplyType < ReplyType.Wheel);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PageTitle.AddSiteNameTitle("自动回复");
        }
