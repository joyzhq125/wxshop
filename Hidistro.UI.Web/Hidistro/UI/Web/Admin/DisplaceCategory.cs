namespace Hidistro.UI.Web.Admin
{
    ...
    public class DisplaceCategory : AdminPage
    {
        ...
        protected DisplaceCategory() : base("", "")
        {
        }
        ...
        private void btnSaveCategory_Click(object sender, EventArgs e)
        {
            ...
            else if (CatalogHelper.DisplaceCategory(this.dropCategoryFrom.SelectedValue.Value, this.dropCategoryTo.SelectedValue.Value,this.wid) == 0)
            {
