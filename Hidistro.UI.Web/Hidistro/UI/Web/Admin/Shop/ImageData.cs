namespace Hidistro.UI.Web.Admin.Shop
{
    ...
    public class ImageData : AdminPage
    {
        ...
        protected HtmlButton btnDelete2;
        ...
        {
            this.btnDelete1.ServerClick += new EventHandler(this.btnDelete_Click);
            this.btnDelete2.ServerClick += new EventHandler(this.btnDelete_Click);
