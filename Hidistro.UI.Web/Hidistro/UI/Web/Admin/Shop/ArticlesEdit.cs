        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                if (str == "addsinglearticle")
                {
                    ...
                    string str8 = "{\"type\":\"0\",\"tips\":\"操作失败！\"}";
                    if (string.IsNullOrEmpty(str3))
                    {
                        str8 = "{\"type\":\"0\",\"tips\":\"请填写标题！\"}";
                        base.Response.Write(str8);
                        base.Response.End();
                    }
                    if (string.IsNullOrEmpty(str4))
                    {
                        str8 = "{\"type\":\"0\",\"tips\":\"请选择封面图片！\"}";
                        base.Response.Write(str8);
                        base.Response.End();
                    }
                    if ((result != 1) && string.IsNullOrEmpty(str2))
                    {
                        str8 = "{\"type\":\"0\",\"tips\":\"请设置链接地址！\"}";
                        base.Response.Write(str8);
                        base.Response.End();
                    }
                    ...
                    if (article.ArticleId > 0)
                    {
                        ...
                        {
                            str8 = "{\"type\":\"1\",\"id\":\"" + article.ArticleId + "\",\"tips\":\"单图文修改成功！\"}";
                        }
                    }
                    else
                    {
                        ...
                        if (num2 > 0)
                        {
                            str8 = "{\"type\":\"1\",\"id\":\"" + num2 + "\",\"tips\":\"单图文新增成功！\"}";
                        }
                    }
                    base.Response.Write(str8);
                    base.Response.End();
                ...
                else if (this.MaterialID > 0)
                {
                    ...
                    if (articleInfo != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this.htmlAddJs = this.htmlAddJs + "$('#divContent').hide();$('#urlData').show();";
                            }
