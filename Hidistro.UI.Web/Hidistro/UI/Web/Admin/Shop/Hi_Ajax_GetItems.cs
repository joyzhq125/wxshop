namespace Hidistro.UI.Web.Admin.Shop
{
    ...
    public class Hi_Ajax_GetItems : IHttpHandler, IRequiresSessionState
    {
        ...
        public string GetGoodsListJson(DbQueryResult GoodsTable)
        {
            ...
            for (int i = 0; i < data.Rows.Count; i++)
            {
                ...
                builder.Append("\"link\":\"/ProductDetails.aspx?productId=" + data.Rows[i]["ProductId"] + "&wid=" + this.wid + "\",");
