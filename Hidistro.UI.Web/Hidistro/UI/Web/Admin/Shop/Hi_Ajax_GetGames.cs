namespace Hidistro.UI.Web.Admin.Shop
{
    ...
    public class Hi_Ajax_GetGames : IHttpHandler
    {
        ...
        {
            return new GameSearch { GameType = new int?((context.Request.Form["type"] == null) ? 1 : Convert.ToInt32(context.Request.Form["type"])), PageIndex = (context.Request.Form["p"] == null) ? 1 : Convert.ToInt32(context.Request.Form["p"]), SortOrder = SortAction.Desc, SortBy = "GameId" };
        }
