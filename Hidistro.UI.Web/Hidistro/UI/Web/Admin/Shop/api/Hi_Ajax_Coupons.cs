namespace Hidistro.UI.Web.Admin.Shop.api
{
    ...
    public class Hi_Ajax_Coupons : IHttpHandler
    {
        ...
        {
            return new CouponsSearch { beginDate = new DateTime?(DateTime.Now), endDate = new DateTime?(DateTime.Now), PageIndex = (context.Request.Form["p"] == null) ? 1 : Convert.ToInt32(context.Request.Form["p"]), Finished = false, SortOrder = SortAction.Desc, SortBy = "CouponId" };
        }
