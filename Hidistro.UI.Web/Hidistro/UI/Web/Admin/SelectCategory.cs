    ...
    public class SelectCategory : AdminPage
    {
        ...
        private void DoCallback()
        {
            ...
            if (str.Equals("getlist"))
            {
                ...
                IList<CategoryInfo> categories = (result == 0) ? CatalogHelper.GetMainCategories(this.wid) : CatalogHelper.GetSubCategories(result,this.wid);
