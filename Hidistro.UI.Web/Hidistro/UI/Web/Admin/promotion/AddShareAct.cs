namespace Hidistro.UI.Web.Admin.promotion
{
    ...
    public class AddShareAct : AdminPage
    {
        ...
        {
            return CouponHelper.GetUnFinishedCoupon(DateTime.Now);
        }
        ...
        protected void Unnamed_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.ShowMsg("活动结束日期不能小于开始日期！", false);
                }
                else
                {
                    ...
                    else if (date < coupon.BeginDate)
                    {
                        this.ShowMsg("活动开始日期不能小于优惠券的开始日期！", false);
                    }
                    else if (time2 > coupon.EndDate)
                    {
                        this.ShowMsg("活动结束日期不能大于优惠券的结束日期！", false);
                    }
