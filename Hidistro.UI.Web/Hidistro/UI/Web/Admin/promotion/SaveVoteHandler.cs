    ...
    public class SaveVoteHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string str5 = context.Request["img"].ToString();
                string str6 = context.Request["des"].ToString();
                bool flag = bool.Parse(context.Request["ismulti"].ToString());
                int num2 = int.Parse(context.Request["maxcheck"].ToString());
                string str7 = context.Request["items"].ToString();
                ...
                else
                {
                    ...
                    vote.VoteName = str;
                    vote.EndDate = i.Date;
                    vote.StartDate = now.Date;
                    vote.MemberGrades = str4;
                    vote.Description = str6;
                    vote.ImageUrl = str5;
