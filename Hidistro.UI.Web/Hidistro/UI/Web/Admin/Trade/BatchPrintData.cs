        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (str)
            {
                ...
                case "getmyaddr":
                    {
                        ...
                        IList<ShippersInfo> shippers = SalesHelper.GetShippers(false,wid);
                ...
                default:
                    ...
                    this.ddlShoperTag.wid = this.wid;
                    this.ddlShoperTag.DataBind();
                    foreach (ShippersInfo info3 in SalesHelper.GetShippers(false,wid))
                    {
