namespace Hidistro.UI.Web.Admin.Goods
{
    ...
    public class ProductEdit : ProductBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.dropProductTypes.wid = this.wid;
            this.dropBrandCategories.wid = this.wid;
            ...
            else
            {
                ...
                PageTitle.AddSiteNameTitle("编辑商品信息");
                ...
                else
                {
                    ...
                    if (this.productId > 0)
                    {
                        ...
                        if (Globals.RequestFormStr("posttype") == "updatecontent")
                        {
                            base.Response.ContentType = "application/json";
                    ...
                    {
                        this.FreightTemplateDownList1.wid = this.wid;
            ...
            if (this.ValidateConverts(this.txtProductName.Text.Trim(), this.chkSkuEnabled.Checked, out num2, out num4, out nullable, out nullable2, out num3, out nullable3, out showSaleCounts, out num6, out num7, out num8, out num9, out num10))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (this.productId > 0)
                        {
                            switch (ProductHelper.UpdateProduct(target, skus, attrs, tagIds,wid))
                            {
                        ...
                        {
                            string s = ProductHelper.AddProductNew(target, skus, attrs, tagIds,wid);
                            ...
                            {
                                this.ShowMsg(this.operatorName + "商品失败，" + s, false);
                            }
                        }
                    }
                }
