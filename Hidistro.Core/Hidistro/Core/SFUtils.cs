...
namespace Hidistro.Core
{
    public class SFUtils
    {
        ...
        #region 传入商户、公众号、模版 num 获取条件字符串
        /// <summary>
        /// 传入商户、公众号、模版 num 获取条件字符串
        /// </summary>
        /// <returns>前面无 and 连接</returns>
        public static string getWhereByInfo(string busnieseNum, string appNum, string templatesNum) 
        {
            string res = " busnieseNum='" + busnieseNum + "' and appNum='" + appNum + "' and templatesNum='" + templatesNum + "' ";
            return res;
        }
        #endregion


        #region 传入商户、公众号获取条件字符串
        /// <summary>
        /// 传入商户、公众号获取条件字符串
        /// </summary>
        /// <returns>前面无 and 连接</returns>
        public static string getWhereByInter(string busnieseNum, string appNum)
        {
            string res = " busnieseNum='" + busnieseNum + "' and appNum='" + appNum + "' ";
            return res;
        }
        #endregion
