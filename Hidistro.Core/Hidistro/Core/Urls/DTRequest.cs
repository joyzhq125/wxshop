...
namespace Hidistro.Core.Urls
{
	...
	public class DTRequest
	{
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !SFUtils.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !SFUtils.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
     ...
     /// <param name="strName">表单参数</param>
        ...
        {
            return SFUtils.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
		...
		{
			return SFUtils.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return SFUtils.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
		}
        ...
        {
            return SFUtils.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return SFUtils.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
		...
		{
			return SFUtils.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return SFUtils.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
		}
		...
		public static string GetIP()
		{
			...
			if (string.IsNullOrEmpty(result) || !SFUtils.IsIP(result))
				return "127.0.0.1";
			return result;
		}
