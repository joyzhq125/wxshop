...
namespace Hidistro.Core
{
    public class DTKeys
    {
        ...
        /// u站点配置
        /// </summary>
        public const string CACHE_U_SITE_CONFIG = "dt_cache_u_site_config";
        /// <summary>
        /// 用户配置
        /// </summary>
        ...
        /// u_网页验证码
        /// </summary>
        public const string U_SESSION_CODE = "dt_u_session_code";
        /// <summary>
        /// 短信验证码
        /// </summary>
        ...
        /// 后台管理员ID
        /// </summary>
        public const string SESSION_ADMIN_ID = "dt_session_admin_id";

        /// <summary>
        /// 网站ID
        /// </summary>
        public const string SESSION_WEB_ID = "dt_session_web_id";

        /// <summary>
        /// 公众号
        /// </summary>
        public const string SESSION_APP_INFO = "dt_session_app_info";
        /// <summary>
        /// 模版
        /// </summary>
        public const string SESSION_TEMPLATES_INFO = "dt_session_templates_info";
        /// <summary>
        /// 会员用户
        /// </summary>
        ...
        /// 商户编号
        /// </summary>
        public const string SESSION_BUSNIESE_NUM = "dt_session_busniese_num";

        /// <summary>
        /// 商户ID
        /// </summary>
        public const string SESSION_BUSNIESE_ID = "dt_session_busniese_id";
