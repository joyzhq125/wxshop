...
namespace Chenduo.BLL
{
	...
	{
		private readonly Chenduo.DAL.sf_business_settlement dal=new Chenduo.DAL.sf_business_settlement();
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.sf_business_settlement> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.sf_business_settlement> DataTableToList(DataTable dt)
		{
			List<Model.sf_business_settlement> modelList = new List<Model.sf_business_settlement>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.sf_business_settlement model;
