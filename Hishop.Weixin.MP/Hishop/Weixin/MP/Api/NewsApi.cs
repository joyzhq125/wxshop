namespace Hishop.Weixin.MP.Api
{
    ...
    public class NewsApi
    {
        ...
        public static string GetErrorCodeMsg(string errcode)
        {
            ...
            StreamWriter writer = File.AppendText(HttpContext.Current.Server.MapPath("error.txt"));
            writer.WriteLine("||++错误编码+" + errcode + "+++||||");
        ...
        public static string GetMedia_IDByPath(string access_token, string path)
        {
            ...
            if (str2.StartsWith("/"))
            {
                try
                {
                    return UploadMedia(access_token, "image", str2);
                }
