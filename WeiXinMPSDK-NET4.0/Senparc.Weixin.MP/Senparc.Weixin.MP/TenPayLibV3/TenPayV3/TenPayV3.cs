...
namespace Senparc.Weixin.MP.AdvancedAPIs
{
    ...
    public static class TenPayV3
    {
        ...
        ///// <param name="data"></param>
        ///// <returns></returns>
        public static string Refund(string data, string certFile, string certPwd)
        {
            ...
            ms.Write(formDataBytes, 0, formDataBytes.Length);
            ms.Seek(0, SeekOrigin.Begin);//设置指针读取位置
            return RequestUtility.HttpPost(urlFormat, null, ms, certFile: certFile, certPasswd: certPwd);
        }
