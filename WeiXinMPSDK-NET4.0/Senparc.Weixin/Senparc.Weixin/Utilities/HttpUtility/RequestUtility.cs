...
namespace Senparc.Weixin.HttpUtility
{
    public static class RequestUtility
    {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int timeOut = Config.TIME_OUT, bool checkValidationResult = false, string certFile = null, string certPasswd = null)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Timeout = timeOut;
            ...
            if (checkValidationResult || url.StartsWith("https", StringComparison.OrdinalIgnoreCase))
            {
            ...
            if (!string.IsNullOrEmpty(certFile))
            {
                ...
                X509Certificate2 cert = new X509Certificate2(path + certFile, certPasswd);
