namespace Hidistro.SqlDal.Sales
{
    ...
    public class ShippingAddressDao
    {
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("INSERT INTO Hishop_UserShippingAddresses(RegionId,UserId,ShipTo,Address,Zipcode,TelPhone,CellPhone,IsDefault,wid) VALUES(@RegionId,@UserId,@ShipTo,@Address,@Zipcode,@TelPhone,@CellPhone,@IsDefault,@wid); SELECT @@IDENTITY");
            ...
            this.database.AddInParameter(sqlStringCommand, "wid", DbType.String, shippingAddress.wid);
