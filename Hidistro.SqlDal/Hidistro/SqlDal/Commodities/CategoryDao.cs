namespace Hidistro.SqlDal.Commodities
{
    ...
    public class CategoryDao
    {
        ...
        public int CreateCategory(CategoryInfo category)
        {
            ...
            this.database.AddInParameter(storedProcCommand, "wid", DbType.String, category.wid);
        ...
        public bool DeleteCategory(int categoryId,string wid)
        {
        ...
        public int DisplaceCategory(int oldCategoryId, int newCategory,string wid)
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("UPDATE Hishop_Products SET CategoryId=@newCategory, MainCategoryPath=(SELECT Path FROM Hishop_Categories WHERE CategoryId=@newCategory)  WHERE CategoryId=@oldCategoryId and wid = @wid");
        ...
        public DataTable GetCategories(string wid)
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("SELECT CategoryId,Name,IconUrl,DisplaySequence,ParentCategoryId,Depth,[Path],RewriteName,HasChildren,FirstCommission,SecondCommission,ThirdCommission FROM Hishop_Categories where wid=@wid ORDER BY DisplaySequence");
            this.database.AddInParameter(sqlStringCommand, "wid", DbType.String, wid);
        ...
        public DataSet GetCategoryList(string wid)
        {
            string str = "select * from Hishop_Categories where ParentCategoryId=0 and wid=@wid;";
            str = str + "select * from Hishop_Categories where ParentCategoryId<>0 and wid=@wid;";
        ...
        public CategoryActionStatus UpdateCategory(CategoryInfo category)
        {
            ...
            this.database.AddInParameter(sqlStringCommand, "wid", DbType.String, category.wid);
