namespace Hidistro.SqlDal.Weibo
{
    ...
    public class MessageDao
    {
        ...
        public DbQueryResult GetMessages(MessageQuery query,string wid)
        {
            ...
            builder.AppendFormat("Access_Token = '{0}'", SettingsManager.GetMasterSettings(false,wid).Access_Token);
