namespace Hidistro.SqlDal.Promotions
{
    ...
    public class PrizeResultDao
    {
        ...
        {
            string selectFields = "LogId, PlayTime, UserId, UserName, PrizeGrade, PrizeType, GivePoint, GiveCouponId, GiveShopBookId ";
        ...
        public IList<PrizeResultViewInfo> GetPrizeLogLists(int gameId, int pageIndex, int pageSize)
        {
            ...
            string selectFields = "LogId, PlayTime, UserId, UserName, PrizeGrade, PrizeType, GivePoint, GiveCouponId, GiveShopBookId ";
            string filter = string.Format(" GameId={0} ", gameId);
        ...
        {
            string str = "Update Hishop_PromotionGameResultMembersLog set IsUsed=1 where LogId=@LogId and IsUsed=0";
