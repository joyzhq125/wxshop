namespace Hidistro.SqlDal.Members
{
    ...
    public class DistributorGradeDao
    {
        ...
        {
            string str = "select * from aspnet_DistributorGrade ";
        ...
        {
            string str = "select * from aspnet_Distributors where DistributorGradeId=@DistributorGradeId";
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand(str);
        ...
        {
            bool flag = false;
            string str = "select top 1 GradeId from aspnet_DistributorGrade where CommissionsLimit=" + minorderamount;
            if (gradeid > 0)
            {
                str = str + " and GradeId<>" + gradeid;
            }
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand(str);
