namespace Hidistro.SqlDal.Members
{
    ...
    public class FavoriteDao
    {
        ...
        public bool AddProductToFavorite(int productId, int userId,string wid)
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("INSERT INTO Hishop_Favorite(wid,ProductId, UserId, Tags, Remark)VALUES(@wid,@ProductId, @UserId, '', '')");
        ...
        {
            string str = "DELETE from Hishop_Favorite WHERE FavoriteId IN (" + ids + ")";
