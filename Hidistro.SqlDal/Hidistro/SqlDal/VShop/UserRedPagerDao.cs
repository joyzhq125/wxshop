namespace Hidistro.SqlDal.VShop
{
    ...
    public class UserRedPagerDao
    {
        ...
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("update Hishop_Coupon_MemberCoupons set Status=@Status,UsedDate=@UsedDate WHERE Id=@Id");
        ...
        public DataTable GetUserRedPager(int userid, UserRedPagerType type)
        {
            ...
            string str2 = string.Format("select * FROM vshop_UserRedPager WHERE UserId={0}" + str + " ORDER BY RedPagerID DESC", userid);
        ...
        public UserRedPagerInfo GetUserRedPagerByRedPagerID(int redpagerid)
        {
            ...
            string str = string.Format("select * FROM vshop_UserRedPager WHERE redpagerid={0}", redpagerid);
