namespace Hidistro.SqlDal.VShop
{
    ...
    public class PrizeRecordDao
    {
        ...
        {
            string str = "select count(*) from Vshop_PrizeRecord where ActivityID=@ActivityID";
        ...
        {
            string str = "select count(*) from Vshop_PrizeRecord where ActivityID=@ActivityID and UserID=@UserID";
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand(str);
            this.database.AddInParameter(sqlStringCommand, "ActivityID", DbType.Int32, activityId);
        ...
        {
            string str = "UPDATE Vshop_PrizeRecord SET  RealName=@RealName, CellPhone=@CellPhone WHERE ActivityID=@ActivityID AND UserId=@UserId AND IsPrize = 1 AND CellPhone IS NULL AND RealName IS NULL";
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand(str);
            this.database.AddInParameter(sqlStringCommand, "ActivityID", DbType.Int32, model.ActivityID);
            this.database.AddInParameter(sqlStringCommand, "UserID", DbType.Int32, model.UserID);
