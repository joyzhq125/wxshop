namespace Hidistro.SqlDal.VShop
{
    ...
    public class OrderRedPagerDao
    {
        ...
        {
            string str = "select top 1 RedPagerActivityId,Name,MaxGetTimes,ItemAmountLimit,ExpiryDays,OrderAmountCanUse from vshop_RedPagerActivity where IsOpen=1 and MinOrderAmount<=@MinOrderAmount order by MinOrderAmount desc";
