namespace Hidistro.SqlDal.VShop
{
    ...
    public class RedRedPagerActivityDao
    {
        ...
        {
            bool flag = false;
            string str = "select top 1 RedPagerActivityId from vshop_RedPagerActivity where MinOrderAmount=" + minorderamount;
            if (redpageractivityid > 0)
            {
                str = str + " and RedPagerActivityId<>" + redpageractivityid;
            }
