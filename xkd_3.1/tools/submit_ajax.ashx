<%@ WebHandler Language="C#" Class="MxWeiXinPF.Web.tools.submit_ajax" %>
...
namespace MxWeiXinPF.Web.tools
{
    ...
    public class submit_ajax : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            //取得处事类型
            string action = Globals.RequestQueryStr("action");
...
/*
        ...
        private void comment_add(HttpContext context)
        {
            ...
            string code = Globals.RequestQueryStr("txtCode");
            int article_id = Globals.RequestQueryNum("article_id");
            string _content = Globals.RequestQueryStr("txtContent");
            //校检验证码
            ...
            model.content = SFUtils.ToHtml(_content);
        ...
        {
            int article_id = Globals.RequestQueryNum("article_id");
            int page_index = Globals.RequestQueryNum("page_index");
            int page_size = Globals.RequestQueryNum("page_size");
            int totalcount;
            StringBuilder strTxt = new StringBuilder();
...
*/
        ...
        {
            int article_id = Globals.RequestQueryNum("id");
            int click = Globals.RequestQueryNum("click");
            int count = 0;
            if (article_id > 0)
            {
