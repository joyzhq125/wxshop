                                            ...
                                            <asp:Repeater ID="rptItemList" runat="server">
                                                <ItemTemplate>
                                                    <div class="orderInfolist clearfix">
                                                        <span style="width: 285px; display: inline-block;"><a href="/ProductDetails.aspx?productId=<%#Eval("ProductID")+"&wid="+this.wid %>" target="_blank" data-toggle="tooltip" data-placement="right" title="<%#Server.HtmlEncode(Eval("ItemDescription").ToString()) %>"><%# Hidistro.Core.Globals.SubStr(Eval("ItemDescription").ToString(),38,"...") %></a></span>
