                        ...
                        <itemstyle  CssClass="Name" />
                            <ItemTemplate >
                                    ...
                                    <div style="float:left;margin-left:10px;">
                                      <%# Eval("ProductCode")%> <br />
                                      <a href='<%#string.Format("../..ProductDetails.aspx?productId={0}&wid={1}",Eval("productId"),this.wid)%>' target="_blank"><asp:Literal ID="lblProductName" runat="server" Text='<%# Eval("ProductName") %>' /></a>
                                    </div>
                            </ItemTemplate>
                        </asp:TemplateField>
