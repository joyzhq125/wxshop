<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="XKD.Web.Admin.index" %>
...
<form id="form1" runat="server">
    ...
    <div class="nav-right">
      ...
      <div class="option">
        ...
        <div class="drop-wrap">
          ...
          <ul class="item">
            <li>
              <a href="<%=uri %>" target="mainframe">管理中心</a>
            </li>
            <li>
              <a href="manager/manager_pwd.aspx" onclick="linkMenuTree(false, '');" target="mainframe">修改密码</a>
            </li>
            <li>
              <asp:LinkButton ID="lbtnExit" runat="server" onclick="lbtnExit_Click"><%=str %></asp:LinkButton>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="main-container">
    <iframe id="mainframe" name="mainframe" frameborder="0" src="<%=uri %>"></iframe>
  </div>
