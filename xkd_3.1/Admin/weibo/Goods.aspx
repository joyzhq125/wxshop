                        ...
                        <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="60%" HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                                    <ItemTemplate>
                                        ...
                                        <div style="float: left;">
                                            <span class="Name"><a href='<%#"../..ProductDetails.aspx?productId="+Eval("ProductId")+"&wid="+this.wid%>'
                                                target="_blank">
                                ...
                                <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%" HeaderStyle-Width="95" HeaderStyle-CssClass=" td_left td_right_fff">
                                    <ItemTemplate>
                                        <button type="button" class="btn btn-default" value='<%= Globals.DomainName+"/ProductDetails.aspx?productId=" %><%#Eval("ProductId")+"&wid="+this.wid %>' onclick="gotovalue(this.value,'<%#Server.HtmlEncode(Eval("ProductName").ToString()) %>','<%#Server.HtmlEncode(Eval("ShortDescription").ToString()) %>','<%#Server.HtmlEncode(Eval("ThumbnailUrl40").ToString()) %>');">选取</button>
