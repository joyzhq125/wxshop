      ...
      <UI:Grid ID="grdProducts" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" DataKeyNames="SkuId" SortOrderBy="SkuId" SortOrder="DESC" CssClass="goods-list" GridLines="None" AllowSorting="true" Width="100%">
             ...
             <Columns>
                <asp:TemplateField HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                      <div style="float:left;width:60px;height:60px;"><a href='<%#"../..ProductDetails.aspx?ProductId="+Eval("ProductId")+"&wid="+this.wid %>' target="_blank"><Hi:ListImage ID="HiImage2"  runat="server" DataField="ThumbnailsUrl" /></a></div>     
                      <div style="float:left;margin-left:10px;line-height:22px;"><span><a href='<%#"../..ProductDetails.aspx?ProductId="+Eval("ProductId")+"&wid="+this.wid %>' target="_blank"><%# Eval("ItemDescription") %></a>
