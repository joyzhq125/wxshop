            ...
            if (productIds.length > 0) {
                ...
                switch (Operation) {
                    ...
                    case "13":
                        ...
                        $("#MyEidtBaseInfoIframe").attr("src", "EditMemberPrices.aspx?ProductIds=" + productIds+"&wid="+'<%=this.wid%>');
                        $('#divEditBaseInfo').modal('toggle').children().css({
                            width: '820px',
                            height: '550px'
                        })
                                            ...
                                            <tr>
                                                <td width="30%">
                                                    ...
                                                    <div class="shop-info">
                                                        ...
                                                        <a class="er" href="javascript:void(0)" onclick="winqrcode('<%#"http://"+Globals.DomainName+"/ProductDetails.aspx?productId="+Eval("ProductId")+"&wid="+Eval("wid")%>');"></a>
                                                        <input type="text" id='urldata<%# Eval("ProductId") %>' placeholder="" name='urldata<%# Eval("ProductId") %>' value='<%#"http://"+Globals.DomainName+"/ProductDetails.aspx?productId="+Eval("ProductId")+"&wid="+Eval("wid")%>' disabled="" style="display: none">
