...
namespace MxWeiXinPF.Web.admin.article
{
    public partial class category_list : AdminPage
    {
        ...
        private void RptBind()
        {
            ...
            DataTable dt = bll.GetWCodeList(this.wid, 0, this.channel_id);
            ...
            if (dt != null)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        dr["link_url"] = "<span class=\"lianjie_wai\">[外]</span>" + " <a href=\"javascript:;\" title=\"" + dr["link_url"].ToString() + "\">" + SFUtils.CutString(dr["link_url"].ToString(), 40) + "</a>";
                    }
                    else
                    {
                        dr["link_url"] = "<span class=\"lianjie_ben\">[本]</span>" + " <a href=\"javascript:;\">" + SFUtils.getWebSite() + "/list.aspx?wid=" + SFUtils.ObjectToStr(dr["wid"]) + "&cid=" + dr["id"] + "</a>";
                    }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功！", SFUtils.CombUrlTxt("category_list.aspx", "channel_id={0}", this.channel_id.ToString()), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除数据成功！", SFUtils.CombUrlTxt("category_list.aspx", "channel_id={0}", this.channel_id.ToString()), "Success");
        }
    }
}