<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wx_article_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_article_edit" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-img").each(function () {
                $(this).InitSWFUpload({ sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.mp4;*.*" });
            });
