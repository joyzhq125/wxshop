<%@ Page Language="C#" AutoEventWireup="true" CodeFile="category_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.category_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="category_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增分类</span></a></li>
                        <li>
