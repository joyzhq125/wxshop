...
{
    public partial class photoHdp_list : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("indexhdp", DTEnums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("indexhdp", DTEnums.ActionEnum.Edit.ToString()); //检查权限
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", SFUtils.CombUrlTxt("photoHdp_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            ChkAdminLevel("indexhdp", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", SFUtils.CombUrlTxt("photoHdp_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}