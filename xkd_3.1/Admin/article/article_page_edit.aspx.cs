...
{
    public partial class article_page_edit : AdminPage
    {
        ...
        private bool DoAdd()
        {
           ...
           // model.link_url = txtLinkUrl.Text.Trim();
            ...
            if (bll.Add(model) > 0)
            {
                ...
                AddAdminLog(DTEnums.ActionEnum.Add.ToString(), "添加单页" + this.channel_name + "内容:" + model.title); //记录日志
                result = true;
            }
            return result;
        }
        ...
        private bool DoEdit(int _id)
        {
           ...
           // model.link_url = txtLinkUrl.Text.Trim();
            ...
            if (bll.Update(model))
            {
                ...
                AddAdminLog(DTEnums.ActionEnum.Edit.ToString(), "修改单页" + this.channel_name + "内容:" + model.title); //记录日志
                result = true;
            }
            return result;
        }
