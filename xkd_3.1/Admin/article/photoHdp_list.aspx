<%@ Page Language="C#" AutoEventWireup="true" CodeFile="photoHdp_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.photoHdp_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="photoHdp_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
                        <li>
                ...
                <li>
                    <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
                        ...
                        <div class="foot">
                            ...
                            <a href="photoHdp_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
                        </div>
                    </div>
                </li>
            </ItemTemplate>
