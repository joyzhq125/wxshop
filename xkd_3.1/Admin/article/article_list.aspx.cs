...
namespace MxWeiXinPF.Web.admin.article
{
    public partial class article_list : AdminPage
    {
        ...
        protected article_list() : base("m01", "dpp10")
        {
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.prolistview = SFUtils.GetCookie("article_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
        ...
        private void RptBind(int _channel_id, int _category_id, string _strWhere, string _orderby)
        {
            ...
            switch (this.prolistview)
            {
                case "Img":
                    ...
                    SFUtils.WriteCookie("article_list_view", "Img", 14400);
                    break;
                default:
                    this.rptList2.Visible = false;
                    this.rptList1.DataSource = artDs;
                    this.rptList1.DataBind();
                    SFUtils.WriteCookie("article_list_view", "Txt", 14400);
                    break;

            }
            //绑定页码
            txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            int _pagesize;
            if (int.TryParse(SFUtils.GetCookie("article_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            SFUtils.WriteCookie("article_list_view", "Txt", 14400);
            Response.Redirect(SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    SFUtils.WriteCookie("article_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", SFUtils.CombUrlTxt("article_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}