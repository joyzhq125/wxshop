<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeFile="article_edit.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.article_edit" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-img").each(function () {
                $(this).InitSWFUpload({ sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.gif;*.jpg;*.png;*.bmp;*.rar;*.zip;*.doc;*.xls;*.txt;*.xlsx;*.docx;*.jpeg;*.mp3;*.mp4" });
            });
