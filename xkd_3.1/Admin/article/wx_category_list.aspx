<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wx_category_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.wx_category_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="wx_category_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增分类</span></a></li>
                        <li>
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="wx_category_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">添加子类</a>
                        <a href="wx_category_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
