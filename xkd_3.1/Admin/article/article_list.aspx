<%@ Page Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeFile="article_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.article_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" class="mainbody" runat="server">
        <!--导航栏-->
        <div class="location">
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li>
                            <asp:LinkButton ID="btnDelete" runat="server" CssClass="del"  OnClientClick="return ExePostBack('ctl00_ContentPlaceHolder1_btnDelete');" OnClick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
                    </ul>
                    <div class="menu-list">
