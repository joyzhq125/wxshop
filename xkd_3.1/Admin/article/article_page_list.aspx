<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article_page_list.aspx.cs" Inherits="MxWeiXinPF.Web.admin.article.article_page_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="article_page_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增单页</span></a></li>
                        <li>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="article_page_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
