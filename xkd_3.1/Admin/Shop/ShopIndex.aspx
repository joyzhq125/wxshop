        ...
        <form id="thisForm" runat="server" class="form-horizontal">
                ...
                <div class="set-switch clearfix">
                    ...
                    <div class="usertemplateInfo">
                        ...
                        <input type ="button" class="btn btn-primary mt20" value ="编辑模板" dataID="<%= GetTempUrl(tempLatePath)%>" webID="<%=wid%>" id ="btn_edit"/>
                                ...
                                <li class="<%# Eval("ThemeName").ToString ()==tempLatePath ?  "active" :""  %>">
                                   ...
                                   <div class="lightBtn">
                                        <div style="display: none;" class="enableExit">
                                            <input type ="button" class="btn btn-sm btn-success"  value ="启用" dataID="<%# Eval("ThemeName")%>" webID="<%=wid%>">
                                             <input type ="button" class="btn btn-sm btn-primary" value ="编辑" dataID="<%# GetTempUrl(Eval("ThemeName").ToString ())%>" webID="<%=wid%>" >
     ...
     <script type="text/javascript">
         $(function () {
             ...
             $(".btn-success").click(function () {          
                 if (ShopIndex.EnableTemp($(this).attr("dataID"),$(this).attr("webID")).value) {
                     ShowMsgAndReUrl("设置成功", true, "/admin/shop/ShopIndex.aspx", null);
                 }
             });

             $("#btn_show").click(function () {
                 window.open ("/Default.aspx?wid="+"<%= wid %>");
                 <%--window.open("<%= showUrl %>");--%>
             });
