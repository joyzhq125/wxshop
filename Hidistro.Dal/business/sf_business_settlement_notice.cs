...
namespace SF.DAL
{
	...
	public partial class sf_business_settlement_notice
	{
		...
		public SF.Model.sf_business_settlement_notice GetModel(long id)
		{
			...
			SF.Model.sf_business_settlement_notice model=new SF.Model.sf_business_settlement_notice();
		...
		/// 得到一个对象实体
		/// </summary>
		public SF.Model.sf_business_settlement_notice DataRowToModel(DataRow row)
		{
			SF.Model.sf_business_settlement_notice model=new SF.Model.sf_business_settlement_notice();
			if (row != null)
			{
