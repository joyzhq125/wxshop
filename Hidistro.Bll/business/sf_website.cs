...
namespace SF.BLL
{
	...
	{
		private readonly SF.DAL.sf_website dal=new SF.DAL.sf_website();
		public sf_website()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<SF.Model.sf_website> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SF.Model.sf_website> DataTableToList(DataTable dt)
		{
			List<SF.Model.sf_website> modelList = new List<SF.Model.sf_website>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SF.Model.sf_website model;
