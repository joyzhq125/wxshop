...
namespace SF.BLL
{
    ...
    public partial class manager_role
    {
        ...
        private String databaseprefix = "sf_";
        public manager_role()
        {
            dal = new DAL.manager_role(databaseprefix/*siteConfig.sysdatabaseprefix*/);
        }
        ...
        public bool Exists(int role_id, string nav_name, string action_type)
        {
            ...
            if (model != null)
            {
                ...
                Model.manager_role_value modelt = model.u_manager_role_values.Find(p => p.nav_name == nav_name && p.action_type == action_type);
                if (modelt != null)
                {
                    return true;
                }
