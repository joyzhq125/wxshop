namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    [ParseChildren(true)]
    public class VSmashEgg : VMemberTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            {
                this.Page.ClientScript.RegisterStartupScript(base.GetType(), "myscript", "<script>alert_h(\"亲，不好意思您的抽奖机会已经用完了哦，敬请期待下次活动吧！\",function(){window.location.href=\"Default.aspx\";});</script>");
            }
            ...
            {
                this.Page.ClientScript.RegisterStartupScript(base.GetType(), "myscript", "<script>alert_h(\"活动还未开始或者已经结束！\",function(){window.location.href=\"Default.aspx\";})</script>");
            }
        }
