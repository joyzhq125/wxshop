namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VGroupBuyProductDetail : VshopTemplatedWebControl
    {
        ...
        private void SetControlsValue(int groupbuyId)
        {
            ...
            {
                this.litConsultationsCount.SetWhenIsNotNull(ProductBrowser.GetProductConsultationsCount(groupBuy.ProductId, false, currentMember.UserId).ToString());
                this.litReviewsCount.SetWhenIsNotNull(ProductBrowser.GetProductReviewsCount(groupBuy.ProductId, currentMember.UserId).ToString());
            }
            else
            {
