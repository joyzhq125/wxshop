namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VProductListAll : VMemberTemplatedWebControl
    {
        ...
        private void DataBindSoruce()
        {
            ...
            this.rpChooseProducts.DataSource = ProductBrowser.GetProducts(MemberProcessor.GetCurrentMember(), null, new int?(this.categoryId), this.keyWord, 1, 10, out num, "DisplaySequence", "desc", false);
