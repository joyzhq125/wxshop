namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VSignUp : VMemberTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            {
                this.Page.ClientScript.RegisterStartupScript(base.GetType(), "myscript", "<script>$(function(){hideSignUpBtn();alert_h(\"活动还未开始或者已经结束！\",function(){window.location.href=\"Default.aspx\";});});</script>");
            }
