namespace Hidistro.ControlPanel.WeiBo
{
    using Hidistro.Core;
    ...
    public class WeiBo
    {
        ...
        public string deletemenu()
        {
            ...
            if (this.sinaweibo.IsAuthorized)
            {
                result = this.sinaweibo.HttpPost("https://m.api.weibo.com/2/messages/menu/delete.json", new List<dynamic>()).Content.ReadAsStringAsync().Result;
            }
            return result;
        }
        ...
        public string get_uid()
        {
            ...
            if (this.sinaweibo.IsAuthorized)
            {
                uid = JsonConvert.DeserializeObject<user>(this.sinaweibo.HttpGet("account/get_uid.json", new List<dynamic>()).Content.ReadAsStringAsync().Result).uid;
            }
            return uid;
        }
        ...
        public string SendToUIDMessage(string msgtype, string displayname, string summary, string image, string url, string Content, string ArticleId)
        {
            ...
            result = this.sinaweibo.HttpGet("https://m.api.weibo.com/2/messages/subscribers/get.json", new List<dynamic>()).Content.ReadAsStringAsync().Result;
            ...
            foreach (string str4 in obj3["uids"])
            {
                str = str + "\"" + str4 + "\",";
            }
        ...
        public string showemenu()
        {
            ...
            if (this.sinaweibo.IsAuthorized)
            {
                result = this.sinaweibo.HttpGet("https://m.api.weibo.com/2/messages/menu/show.json", new List<dynamic>()).Content.ReadAsStringAsync().Result;
            }
            return result;
        }
