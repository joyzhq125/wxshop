namespace Hidistro.ControlPanel.Sales
{
    ...
    public static class RefundHelper
    {
        ...
        public static RefundInfo GetByOrderId(string orderId)
        {
            return new RefundDao().GetByOrderId(orderId);
        }

        public static RefundInfo GetByOrderIdAndProductID(string orderId, int productid)
        {
            return new RefundDao().GetByOrderIdAndProductID(orderId, productid);
        }
