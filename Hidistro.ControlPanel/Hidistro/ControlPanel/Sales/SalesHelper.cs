namespace Hidistro.ControlPanel.Sales
{
    ...
    public sealed class SalesHelper
    {
        ...
        public static PaymentModeInfo GetPaymentMode(string gateway,string wid)
        {
            return new PaymentModeDao().GetPaymentMode(gateway,wid);
        }
        ...
        public static IList<ShippersInfo> GetShippers(bool includeDistributor,string wid)
        {
            return new ShipperDao().GetShippers(includeDistributor,wid);
        }
