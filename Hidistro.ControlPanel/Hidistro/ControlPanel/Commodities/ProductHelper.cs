namespace Hidistro.ControlPanel.Commodities
{
    ...
    public static class ProductHelper
    {
        ...
        public static int GetMaxSequence(string wid)
        {
            return new ProductDao().GetMaxSequence(wid);
        }
        ...
        public static DataTable GetProductNum(string wid)
        {
            return new ProductDao().GetProductNum(wid);
        }
        ...
        public static int GetProductsCount(string wid)
        {
            return new ProductDao().GetProductsCount(wid);
        }
        ...
        public static DataTable GetSkuMemberPrices(string productIds,string wid)
        {
            return new ProductBatchDao().GetSkuMemberPrices(productIds,wid);
        }
        ...
        public static DataTable GetTopProductOrder(int top, string showOrder,string wid)
        {
            if (top < 1)
            {
                top = 6;
            ...
            return new ProductDao().GetTopProductOrder(top, showOrder,wid);
        }
        ...
        public static void ImportProducts(DataSet productData, int categoryId, int lineId, int? bandId, ProductSaleStatus saleStatus, bool includeCostPrice, bool includeStock, bool includeImages,string wid)
        {
            foreach (DataRow row in productData.Tables["products"].Rows)
            {
                ...
                AddProduct(product, skus, attrs, null,wid);
            }
        }
