namespace Hidistro.ControlPanel.Settings
{
    ...
    public sealed class SettingsHelper
    {
        ...
        {
            return new Hidistro.SqlDal.Sales.ExpressTemplateDao().DeleteExpressTemplates(expressIds);
        }
        ...
        public static DataTable GetAllFreightItems(string wid)
        {
            return new ShippingModeDao().GetAllFreightItems(wid);
        }
        ...
        public static IList<FreightTemplate> GetFreightTemplates(string wid)
        {
            return new Hidistro.SqlDal.Sales.ExpressTemplateDao().GetFreightTemplates(wid);
        }
        ...
        {
            return new Hidistro.SqlDal.Sales.ExpressTemplateDao().SetExpressDefault(expressId);
        }
