...
namespace MxWeiXinPF.Templates
{
    public class TemplateMgr
    {
        ...
        public TemplateMgr(string tPath, string wid)
        {
        ...
        /// <param name="wid"></param>
        public void OutPutHtml(string templateFileName, string wid)
        {
            //注册一个自定义函数
            ...
            this.Document.SetValue("thisurl", SFUtils.getTotalUrl());
            this.Document.SetValue("yuming", SFUtils.getWebSite());
        ...
        {
            int category_id = Globals.RequestQueryNum("cid");
            ...
            int totPage = 1;//总页数
            int pageSize = SFUtils.StrToInt(pagesizeStr,10);//每页的记录数
            if (pageSize <= 0)
            {
                pageSize = 10;
            }
            if (Globals.RequestQueryNum("page") > 0)
            {
                currPage = Globals.RequestQueryNum("page");
            }
            ...
            {
                beforePageStr = SFUtils.ChangePageNum(SFUtils.getTotalUrl(), (currPage - 1));
            ...
            {
                nextPageStr = SFUtils.ChangePageNum(SFUtils.getTotalUrl(), (currPage + 1));
