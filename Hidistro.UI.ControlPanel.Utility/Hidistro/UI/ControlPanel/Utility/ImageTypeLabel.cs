namespace Hidistro.UI.ControlPanel.Utility
{
    ...
    public class ImageTypeLabel : Label
    {
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            {
                object obj3 = str;
                str = string.Concat(new object[] { obj3, "<li><a href=\"", Globals.ApplicationPath, "/admin/store/ImageData.aspx?pageSize=20&ImageTypeId=0\"><s></s><strong>默认分组<span>(", defaultPhotoCount, ")</span></strong></a></li>" });
            }
