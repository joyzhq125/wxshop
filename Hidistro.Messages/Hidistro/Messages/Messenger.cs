namespace Hidistro.Messages
{
    ...
    public static class Messenger
    {
        ...
        public static void OrderClosed(MemberInfo user, OrderInfo order, string reason,string wid)
        {
            if (user != null)
            {
                //SF.Model.sf_website website = new SF.BLL.sf_website().GetModelByWid(wid);
                MessageTemplate template = MessageTemplateHelper.GetTemplate("OrderClosed",wid);
                if (template != null)
                {
                    MailMessage email = null;
                    string innerSubject = null;
        ...
        public static void OrderCreated(OrderInfo order, MemberInfo user,string wid)
        {
            if ((order != null) && (user != null))
            {
                MessageTemplate template = MessageTemplateHelper.GetTemplate("OrderCreated",wid);
                if (template != null)
                {
                    MailMessage email = null;
                    string innerSubject = null;
        ...
        public static void OrderCreatedSendManage(OrderInfo order, MemberInfo user,string wid)
        {
            if ((order != null) && (user != null))
            {
                MessageTemplate template = MessageTemplateHelper.GetTemplate("OrderCreated",wid);
        ...
        public static void OrderPayment(MemberInfo user, string orderId, decimal amount,string wid)
        {
            if (user != null)
            {
                MessageTemplate template = MessageTemplateHelper.GetTemplate("OrderPayment",wid);
                if (template != null)
                {
                    MailMessage email = null;
                    string innerSubject = null;
        ...
        public static SendStatus SendMail(string subject, string body, string emailTo, SiteSettings settings, out string msg)
        {
            ...
            if (!SendMail(email, sender, out msg))
            {
        ...
        public static SendStatus SendSMS(string phoneNumber, string message, SiteSettings settings, out string msg)
        {
            ...
            if (!sender.Send(phoneNumber, message, out msg))
            {
                return SendStatus.Fail;
            }
            return SendStatus.Success;
        ...
        public static SendStatus SendSMS(string[] phoneNumbers, string message, SiteSettings settings, out string msg)
        {
            ...
            if (!sender.Send(phoneNumbers, message, out msg))
            {
                return SendStatus.Fail;
            }
            return SendStatus.Success;
        ...
        public static void UserPasswordChanged(MemberInfo user, string changedPassword,string wid)
        {
            if (user != null)
            {
                MessageTemplate template = MessageTemplateHelper.GetTemplate("ChangedPassword",wid);
                if (template != null)
                {
                    MailMessage email = null;
                    string innerSubject = null;
